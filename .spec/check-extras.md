...
- `rg -B8 'def contact_search\b' src/mailpilot/cli.py` -> `@limit_option` present
- `rg -B8 'def email_search\b' src/mailpilot/cli.py` -> `@limit_option` present
- `rg -B8 'def workflow_search\b' src/mailpilot/cli.py` -> `@limit_option` present
