...
T122|.|fix stale scenario count — smoke-test SKILL.md:12 "Two scenarios share one Phase 0 setup" -> "Three" (Scenarios A/B/C; :23 already says "All three"); leftover from before Scenario C landed. Scope = grep `rg -n 'Two scenarios' .claude/skills/smoke-test/SKILL.md` -> zero hits. Skill-prose only.|-
